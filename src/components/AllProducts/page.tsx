'use client'
import ProductCardRowStyleTwo from '@/components/cards/ProductsCardstyle2'
import DataIteration from '../Bestproduct/DataIteration'
...
export default function AllProductPage({
  ...
  const image = products[0]?.gallery?.[0]?.image
