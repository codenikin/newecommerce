    ...
    <div className="flex flex-col items-stretch justify-stretch my-8 px-8 md:flex-row grow gap-10 md:gap-6 lg:gap-8 mt-32">
      <div className="basis-full lg:basis-2/3 flex flex-col gap-8 justify-stretch border border-primary rounded-md p-8">
        ...
        {!paymentData && (
          ...
          >
            {paymentMethod === 'stripe' ? 'Go to Payment' : 'Place Order'}
          </Button>
        )}
                ...
                options={{
                  appearance: {
                    ...
                    variables: {
                      ...
                      gridRowSpacing: '20px',
                      colorBackground: theme === 'dark' ? '#ffffff' : cssVariables.colors.base0,
              ...
              if (isVariant) {
                ...
                const imageVariant = product.gallery?.find(
                  (item: { variantOption: { id: any } }) => {
                    ...
                    const hasMatch = variant?.options?.some((option: { id: any }) => {
