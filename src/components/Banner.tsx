    ...
    },
    {
      ...
      icon: (
        <svg width="32" height="35" viewBox="0 0 32 35" fill="none">
          <path d="M7 13H5.5C2.95 13 1 11.05 1 8.5V1H7" stroke="#FFBB38" strokeWidth="2" />
          <path d="M25 13H26.5C29.05 13 31 11.05 31 8.5V1H25" stroke="#FFBB38" strokeWidth="2" />
          <path d="M16 28V22" stroke="#FFBB38" strokeWidth="2" />
          <path
    ...
    <div className={`w-full ${className || ''}`}>
      <div className="max-w-7xl mx-auto">
        <div className="main-wrapper w-full">
          <div className=" xl:flex xl:space-x-7.5 xl:h-150 mb-7.5">
            <div className="xl:w-180 w-full h-full">
              <Link href="/single-product" className="block h-full">
                <img src="/banner-1.png" alt="" className="w-full h-full object-cover" />
              </Link>
            </div>
            <div className="flex-1 flex xl:flex-col flex-row xl:gap-1.25 h-full">
              <div className="w-full xl:h-1/2">
                <Link href="/single-product" className="block h-full">
                  <img src="/banner-2.png" alt="" className="w-full h-full object-contain" />
                </Link>
              </div>
